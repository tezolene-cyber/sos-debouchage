...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gray-100">
      <form onSubmit={handleLogin} className="max-w-md w-full px-6 py-8 bg-white rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mb-6">Connexion Artisan</h1>
        ...
        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg w-full">Se connecter</button>
        <p className="mt-4 text-center"><a href="/auth/signup" className="text-blue-500">Créer un compte</a></p>
      </form>
    </div>
  );
}